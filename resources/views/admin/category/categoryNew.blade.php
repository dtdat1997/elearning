...
@section('title')
    {!! __('controlpanel.app_title_prefix') . ucfirst(request()->route('name')) . __('controlpanel.category.name') . __('controlpanel.category.view.new')!!}
@endsection
...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <!-- BEGIN: Subheader -->
    {!! renderSubHead([ucfirst(request()->route('name')), __('controlpanel.category.name'), __('controlpanel.category.view.new')]) !!}
